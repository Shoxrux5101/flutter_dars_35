    ...
    return ChangeNotifierProvider(
      create: (context) => TopChefsProfileViewModel(
        repository: TopChefsProfileRepository(
          dioClient: ApiClient(
            interceptor: AuthInterceptor(secureStorage: const FlutterSecureStorage()),
          ),
        ),
      ...
      child: Consumer<TopChefsProfileViewModel>(
        builder: (context, vm, child) {
          ...
          return Scaffold(
            ...
            extendBody: true,
            appBar: CustomAppBar(title: chefsModel.userName),
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text("Recipes", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Colors.white)),
                  Container(width: double.infinity, height: 1.h, color: Colors.red),
